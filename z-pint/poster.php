    ...
    <div class="banner-content text-center">
      <?php if (isset($_SESSION['user'])) : ?>
        <h1>
          ...
          Publiez facilement vos images, et regardez celles des autres utilisateurs.
  ...
  <section>
    <div class="container mt-3">
      <div class="form-group">
        <form action="Traitements/post.php" method="post" enctype="multipart/form-data">
          <div>
            <?php
            ...
            ?>
                  <div class="alert alert-danger">
                    <strong>Erreur! </strong>Votre image n'a pas été publiée. Réessayez.
                  </div>
                <?php
                  break;
            ...
            ?>
                  <div class="alert alert-success">
                    <strong>Réussie! </strong>Votre image a bien été publiée. <a href="index.php"> Voir</a>
                  </div>
            <?php
                  break;
              }
          ...
          <br><br><br><br>
          <div class="">
            <input type="file" name="fichier" class="genric-btn primary" id="formFile">
            <button type="submit" class="genric-btn primary e-large" name="poster" style="float:right;">Poster</button>
          </div>
