...
<?php require_once 'Traitements/categorie.php'; ?>
          ...
          <div class="single-amenities">
            ...
            <div class="amenities-details">
              ...
              <div class="d-flex justify-content-between mt-20">
                ...
                <div class="category">
                  <span class="ti-calendar"> Posté le : <?=$row['date'] ; ?></span>
